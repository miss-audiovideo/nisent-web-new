        ...
        return (
            <div>
                ...
                <div style={{marginTop: "10%"}}>
	                <h4 style={{color: "#FF3147"}}>WHY CHOOSE US</h4>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-footer-widget">
						...
						<p style={{color: "black"}}>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy.</p>
						<div class="row">
                ...
                <div class="col-lg-3  col-md-6 col-sm-6">
					<div class="single-footer-widget mail-chimp">
						<svg  style={{color: "black", fontWeight:"bolder"}} xmlns="http://www.w3.org/2000/svg" width="69.727" height="69.72" viewBox="0 0 69.727 69.72">
                        <g fill="black" transform="translate(-1275 -2241)">
